...
JsonDocument AnymaEspSettings::get_json()
{
    ...
    JSON_PUT(dmx_address);
    JSON_PUT(shutter_closed);
    JSON_PUT(position_closed);
    JSON_PUT(position_open);
    JSON_PUT(shutter_speed);
...
err_t AnymaEspSettings::read()
{
    ...
    else
    {
        ...
        JSON_GET(dmx_address);
        JSON_GET(shutter_closed);
        JSON_GET(position_closed);
        JSON_GET(position_open);
        JSON_GET(shutter_speed);
        // --------------------------------------------- END CUSTOM
